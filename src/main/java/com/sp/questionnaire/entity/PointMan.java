...
public class PointMan {
	...
	/**
	 * @param pointManNo the pointManNo to set
	 */
	...
	/**
	 * @param inCurrentCountry the inCurrentCountry to set
	 */
	...
	/**
	 * @param currentAddr the currentAddr to set
	 */
	...
	/**
	 * @param isOtherPointmanRel the isOtherPointmanRel to set
	 */
	...
	/**
	 * @param otherPointmanName the otherPointmanName to set
	 */
	...
	/**
	 * @param otherPointmanRel the otherPointmanRel to set
	 */
